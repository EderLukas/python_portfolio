...
# Choose random word
def next_card():
    """Chooses random word from words_dict and updates lbl_word with it."""
...
btn_correct = Button(image=img_correct, highlightthickness=0, command=is_known)
btn_correct.grid(column=1, row=1)

img_false = PhotoImage(file="images/wrong.png")
btn_false = Button(image=img_false, highlightthickness=0, command=next_card)
btn_false.grid(column=0, row=1)
